...
{
    public class CountryComboBoxAccessor<TField, TDAO> : ComboBoxAccessor<TField, TDAO, OxCountry, OxCountryComboBox>
        ...
        where TDAO : RootDAO<TField>, new()
    {
        protected override void AfterControlsCreated()
        {
            ...
            ComboBox.LoadCountries(OxCountryField.IsPSN, true);
        }
